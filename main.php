...
<div class="collapse" id="navbarToggleExternalContent" data-bs-theme="dark">
  <div class="bg-dark p-4">
    <h5 class="text-body-emphasis h4">SD MUHAMMADIYAH 5</h5>
...
<div class="card border-info text-bg-dark shadow">
  ...
  <div class="card-body">
    <h5 class="card-title text-info">Administrasi Buku</h5>
    <p class="card-text">Kelola Transaksi, data pinjaman buku, denda dan pengembalian buku.</p>
    <a href="pages/transaksi/p_transaksi.php" class="btn btn-primary">Buka Administrasi</a>
  </div>
</div>
<!-- CARD END -->
        </div>
